...
func DoHeapProfile() {
	...
	DumpHeap()
	PrintGCSummary()
	fmt.Println("Finish heap profile. Please check dump file.")
}
...
func DumpHeap() {
	filename := "heap-" + strconv.Itoa(os.Getpid()) + "-" + strconv.Itoa(int(atomic.AddInt32(&heapProfileCounter, 1))) + ".pprof"
